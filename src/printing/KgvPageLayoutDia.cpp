...
/*======================== draw contents =========================*/
void KgvPagePreview::drawContents( QPainter *painter )
{
...
/*==================== constructor ===============================*/
KgvPageLayoutDia::KgvPageLayoutDia( QWidget* parent, const char* name,
                                  KgvPageLayout& layout,
                                  const KgvHeadFoot& hf, int tabs,
                                  KgvUnit::Unit unit, bool modal )
...
KgvPageLayoutDia::KgvPageLayoutDia( QWidget* parent, const char* name,
                  KgvPageLayout& layout,
                  const KgvHeadFoot& hf,
                  const KgvColumns& columns,
                  const KgvKWHeaderFooter& kwhf,
...
{
    bool res = false;
    KgvPageLayoutDia *dlg = new KgvPageLayoutDia( parent, "PageLayout", layout, hf, tabs, unit );
...
{
    bool res = false;
    KgvPageLayoutDia *dlg = new KgvPageLayoutDia( parent, "PageLayout", layout, hf, columns, _kwhf, tabs, unit );
...
void KgvPageLayoutDia::setupTab1( bool enableBorders )
{
    ...
    m_pageSizeTab = new KgvPageLayoutSize(tab1, m_layout, m_unit, m_column, !(flags & DISABLE_UNIT), enableBorders );
