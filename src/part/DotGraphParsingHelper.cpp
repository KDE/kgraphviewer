...
{
//   qDebug() << "Setting attributes list for " << QString::fromStdString(attributed);
  if (attributed == "graph")
  {
...
void DotGraphParsingHelper::createsubgraph()
{
  ...
  if (phelper)
  {
    ...
    {
      qDebug() << "Creating a new subgraph";
    ...
    {
      qDebug() << "Found existing subgraph";
